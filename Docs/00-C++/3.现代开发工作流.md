...
笔者早期在CSDN上记录一些解题思路的博客，如果没有那个好大哥苦心孤诣地给我介绍Github、Markdown、CMake，那么我可能现在依旧沉溺在自己的世界中继续跟自己斗智斗勇...
...
还有一个问题，虽然Markdown是很强，但它毕竟只是单个文件的文档，不能很好的组织文档间的关联关系，这个时候就有其他工具了，推荐比较多的是：

- **Notion**
- **Obsidian**
- **Remnote** 

> 具体选择什么，大家可以看下这里知乎上提问：[你在 Notion、Obsidian、Remnote 等之间做出什么选择，为什么这么选？](https://www.zhihu.com/question/407810894/answer/2095659162)
