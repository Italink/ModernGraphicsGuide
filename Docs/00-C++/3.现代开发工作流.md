...
笔者早期学习的时候并不了解什么版本管理工具，因为平时就是刷刷题，代码量撑死也就一两百行，写个小工程也不过千行，直到后面工程的体量变大之后问题才逐渐暴露出来：
...
虽然Markdown是很强，但它毕竟只是单个文件的文档，不能很好的组织文档间的关联关系这个时候就有其他工具了
...
> 关于具体的选择，大家可以看下这里知乎上提问：[你在 Notion、Obsidian、Remnote 等之间做出什么选择，为什么这么选？](https://www.zhihu.com/question/407810894/answer/2095659162)
